...
import { User, Mail, Lock, Loader2, AlertCircle, Sparkles, Zap, Shield } from "lucide-react"
            ...
            <div className="text-center lg:text-left space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-300 max-w-lg">
                  Transform your workflow with AI-powered document processing and intelligent automation.
                </p>
              </div>
